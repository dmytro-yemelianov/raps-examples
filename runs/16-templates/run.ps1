...
Invoke-Sample -Id "SR-250" -Slug "template-list" `
  -Command "raps template list --account $env:ACCOUNT_ID" `
...
Invoke-Sample -Id "SR-251" -Slug "template-create" `
  -Command "raps template create --account $env:ACCOUNT_ID --name `"Standard Building Template`"" `
...
Invoke-Sample -Id "SR-252" -Slug "template-info" `
  -Command "raps template info $env:TEMPLATE_ID --account $env:ACCOUNT_ID" `
...
Invoke-Sample -Id "SR-253" -Slug "template-update" `
  -Command "raps template update $env:TEMPLATE_ID --account $env:ACCOUNT_ID --name `"Standard Building Template v2`"" `
...
Invoke-Sample -Id "SR-254" -Slug "template-archive" `
  -Command "raps template archive $env:TEMPLATE_ID --account $env:ACCOUNT_ID" `
...
Invoke-LifecycleStep -StepNum 1 -Command "raps template create --account $env:ACCT --name `"Healthcare Template`""
Invoke-LifecycleStep -StepNum 2 -Command "raps template list --account $env:ACCT"
Invoke-LifecycleStep -StepNum 3 -Command "raps template info $env:TPL_ID --account $env:ACCT"
Invoke-LifecycleStep -StepNum 4 -Command "raps template update $env:TPL_ID --account $env:ACCT --name `"Healthcare Template 2026`""
Invoke-LifecycleStep -StepNum 5 -Command "raps template archive $env:TPL_ID --account $env:ACCT"
Invoke-LifecycleStep -StepNum 6 -Command "raps template list --account $env:ACCT"
End-Lifecycle
