...
lifecycle_step 2  "raps object upload review-cycle ./test-data/sample.rvt"
...
lifecycle_step 3  "raps object upload ci-build-123 ./test-data/sample.rvt"
...
lifecycle_step 9  "raps translate manifest \$URN1"
...
lifecycle_step 2  "raps object upload da-job ./test-data/sample.rvt"
lifecycle_step 3  "raps object signed-url da-job sample.rvt"
...
lifecycle_step 2  "raps reality upload \$JID ./test-data/sample.rvt"
...
lifecycle_step 7  "raps object upload survey-upload ./test-data/sample.rvt"
...
lifecycle_step 4 "raps admin user update $TEST_USER_OLD_ADMIN -a \$ACCT -r \"viewer\" --from-role \"project_admin\" -f \"name:*2024*\" --dry-run"
lifecycle_step 5 "raps admin user update $TEST_USER_OLD_ADMIN -a \$ACCT -r \"viewer\" --from-role \"project_admin\" -f \"name:*2024*\" -y"
...
lifecycle_step 6  "raps object upload staging ./test-data/sample.rvt"
