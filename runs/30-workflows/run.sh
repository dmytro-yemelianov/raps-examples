...
lifecycle_step 3 "raps admin user add pm@co.com -a \$ACCT -r \"project_admin\" -f \"name:*Hospital Wing B*\" -y"
lifecycle_step 4 "raps admin user add struct@co.com -a \$ACCT -r \"viewer\" -f \"name:*Hospital Wing B*\" -y"
lifecycle_step 5 "raps admin user add mep@co.com -a \$ACCT -r \"viewer\" -f \"name:*Hospital Wing B*\" -y"
lifecycle_step 6 "raps admin folder rights struct@co.com -a \$ACCT -l view-download-upload --folder \"Structural\" -f \"name:*Hospital Wing B*\" -y"
lifecycle_step 7 "raps admin folder rights mep@co.com -a \$ACCT -l view-download-upload --folder \"MEP\" -f \"name:*Hospital Wing B*\" -y"
...
lifecycle_step 3 "raps admin project list -a \$ACCT -f \"name:*2024*\" --status active"
lifecycle_step 4 "raps admin user update admin@old.com -a \$ACCT -r \"viewer\" --from-role \"project_admin\" -f \"name:*2024*\" --dry-run"
lifecycle_step 5 "raps admin user update admin@old.com -a \$ACCT -r \"viewer\" --from-role \"project_admin\" -f \"name:*2024*\" -y"
