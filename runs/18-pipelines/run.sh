...
run_sample "SR-270" "pipeline-sample" \
  "raps pipeline sample --output ./sample-pipeline.yaml" \
...
run_sample "SR-271" "pipeline-validate" \
  "raps pipeline validate --file ./sample-pipeline.yaml" \
...
run_sample "SR-272" "pipeline-run" \
  "raps pipeline run --file ./sample-pipeline.yaml" \
...
lifecycle_step 3 "raps pipeline run --file ./my-pipeline.yaml"
lifecycle_end
