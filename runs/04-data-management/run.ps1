...
Invoke-Sample -Id "SR-075" -Slug "folder-list" `
  -Command "raps folder list --project $env:PROJECT_ID --folder $env:FOLDER_ID" `
...
Invoke-Sample -Id "SR-076" -Slug "folder-create" `
  -Command "raps folder create --project $env:PROJECT_ID --parent $env:FOLDER_ID --name 'Test Folder'" `
...
Invoke-Sample -Id "SR-077" -Slug "folder-rename" `
  -Command "raps folder rename --project $env:PROJECT_ID --folder $env:NEW_FOLDER_ID --name 'Renamed Folder'" `
...
Invoke-Sample -Id "SR-078" -Slug "folder-rights" `
  -Command "raps folder rights --project $env:PROJECT_ID --folder $env:FOLDER_ID" `
...
Invoke-Sample -Id "SR-079" -Slug "folder-delete" `
  -Command "raps folder delete --project $env:PROJECT_ID --folder $env:NEW_FOLDER_ID --yes" `
...
Invoke-Sample -Id "SR-084" -Slug "item-delete" `
  -Command "raps item delete $env:PROJECT_ID $env:ITEM_ID --yes" `
...
Invoke-LifecycleStep -StepNum 4 -Command "raps folder list --project $env:PROJECT_ID --folder $env:ROOT_FOLDER"
Invoke-LifecycleStep -StepNum 5 -Command "raps folder list --project $env:PROJECT_ID --folder $env:SUBFOLDER"
End-Lifecycle
...
Invoke-LifecycleStep -StepNum 1 -Command "raps folder create --project $env:PROJECT_ID --parent $env:ROOT --name 'Phase 1'"
Invoke-LifecycleStep -StepNum 2 -Command "raps folder create --project $env:PROJECT_ID --parent $env:PHASE1 --name 'Structural'"
Invoke-LifecycleStep -StepNum 3 -Command "raps folder create --project $env:PROJECT_ID --parent $env:PHASE1 --name 'MEP'"
Invoke-LifecycleStep -StepNum 4 -Command "raps folder list --project $env:PROJECT_ID --folder $env:PHASE1"
Invoke-LifecycleStep -StepNum 5 -Command "raps folder rename --project $env:PROJECT_ID --folder $env:MEP --name 'MEP Systems'"
Invoke-LifecycleStep -StepNum 6 -Command "raps folder rights --project $env:PROJECT_ID --folder $env:PHASE1"
Invoke-LifecycleStep -StepNum 7 -Command "raps folder delete --project $env:PROJECT_ID --folder $env:MEP --yes"
Invoke-LifecycleStep -StepNum 8 -Command "raps folder delete --project $env:PROJECT_ID --folder $env:STRUCTURAL --yes"
Invoke-LifecycleStep -StepNum 9 -Command "raps folder delete --project $env:PROJECT_ID --folder $env:PHASE1 --yes"
End-Lifecycle
...
Invoke-LifecycleStep -StepNum 1 -Command "raps bucket create --name dm-staging --policy transient"
Invoke-LifecycleStep -StepNum 2 -Command "raps object upload --bucket dm-staging --file ./test-data/sample.rvt"
...
Invoke-LifecycleStep -StepNum 7 -Command "raps item delete $env:PROJECT_ID $env:ITEM_ID --yes"
Invoke-LifecycleStep -StepNum 8 -Command "raps bucket delete --name dm-staging --yes"
End-Lifecycle
