...
Invoke-Sample -Id "SR-181" -Slug "webhook-create" `
  -Command "raps webhook create --event `"dm.version.added`" --url `"https://example.com/webhook`"" `
...
Invoke-Sample -Id "SR-183" -Slug "webhook-get" `
  -Command "raps webhook get --event `"dm.version.added`" --hook-id $env:WEBHOOK_ID" `
...
Invoke-Sample -Id "SR-184" -Slug "webhook-update" `
  -Command "raps webhook update --event `"dm.version.added`" --hook-id $env:WEBHOOK_ID --status `"inactive`"" `
...
Invoke-Sample -Id "SR-187" -Slug "webhook-delete" `
  -Command "raps webhook delete $env:WEBHOOK_ID --event `"dm.version.added`" --yes" `
...
Invoke-LifecycleStep -StepNum 2 -Command "raps webhook create --event `"dm.version.added`" --url `"https://hooks.example.com/aps`""
Invoke-LifecycleStep -StepNum 3 -Command "raps webhook list"
Invoke-LifecycleStep -StepNum 4 -Command "raps webhook get --event `"dm.version.added`" --hook-id $env:ID"
Invoke-LifecycleStep -StepNum 5 -Command "raps webhook test `"https://hooks.example.com/aps`""
Invoke-LifecycleStep -StepNum 6 -Command "raps webhook update --event `"dm.version.added`" --hook-id $env:ID --status `"inactive`""
Invoke-LifecycleStep -StepNum 7 -Command "raps webhook get --event `"dm.version.added`" --hook-id $env:ID"
Invoke-LifecycleStep -StepNum 8 -Command "raps webhook delete $env:ID --event `"dm.version.added`" --yes"
End-Lifecycle
