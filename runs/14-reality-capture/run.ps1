...
Invoke-Sample -Id "SR-232" -Slug "reality-create" `
  -Command "raps reality create --name `"Site Survey 2026-02`" --format obj" `
...
Invoke-Sample -Id "SR-233" -Slug "reality-upload" `
  -Command "raps reality upload --job $env:JOB_ID --photos ./site-photos/" `
...
Invoke-Sample -Id "SR-234" -Slug "reality-process" `
  -Command "raps reality process --job $env:JOB_ID" `
...
Invoke-Sample -Id "SR-235" -Slug "reality-status" `
  -Command "raps reality status --job $env:JOB_ID" `
...
Invoke-Sample -Id "SR-236" -Slug "reality-result" `
  -Command "raps reality result --job $env:JOB_ID --output ./results/" `
  -Expects "Expected: Downloads processed output files" `
  -Review "Review: Exit 0; output files exist at specified path"

# SR-237: Delete a reality capture job
Invoke-Sample -Id "SR-237" -Slug "reality-delete" `
  -Command "raps reality delete --job $env:JOB_ID --yes" `
...
Invoke-LifecycleStep -StepNum 2 -Command "raps reality create --name `"Foundation Survey`" --format obj"
Invoke-LifecycleStep -StepNum 3 -Command "raps reality upload --job $env:JID --photos ./site-photos/"
Invoke-LifecycleStep -StepNum 4 -Command "raps reality process --job $env:JID"
Invoke-LifecycleStep -StepNum 5 -Command "raps reality status --job $env:JID"
Invoke-LifecycleStep -StepNum 6 -Command "raps reality result --job $env:JID --output ./survey-results/"
Invoke-LifecycleStep -StepNum 7 -Command "raps reality list"
Invoke-LifecycleStep -StepNum 8 -Command "raps reality delete --job $env:JID --yes"
End-Lifecycle
