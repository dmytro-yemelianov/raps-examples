...
Invoke-Sample -Id "SR-190" -Slug "admin-user-list-account" `
  -Command "raps admin user list -a $env:ACCOUNT_ID" `
...
Invoke-Sample -Id "SR-191" -Slug "admin-user-list-project" `
  -Command "raps admin user list -a $env:ACCOUNT_ID -p $env:PROJECT_ID" `
...
Invoke-Sample -Id "SR-192" -Slug "admin-user-list-filtered" `
  -Command "raps admin user list -a $env:ACCOUNT_ID --role `"project_admin`" --status `"active`" --search `"john`"" `
...
Invoke-Sample -Id "SR-195" -Slug "admin-user-add-from-file" `
  -Command "raps admin user add user@company.com -a $env:ACCOUNT_ID -r `"viewer`" --project-ids ./project-ids.txt -y" `
...
Invoke-Sample -Id "SR-198" -Slug "admin-user-update-from-csv" `
  -Command "raps admin user update user@company.com -a $env:ACCOUNT_ID --from-csv ./role-changes.csv -y" `
...
Invoke-Sample -Id "SR-199" -Slug "admin-user-add-single" `
  -Command "raps admin user add-to-project -p $env:PROJECT_ID -e `"new.user@company.com`" -r $env:ROLE_ID" `
...
Invoke-Sample -Id "SR-200" -Slug "admin-user-update-single" `
  -Command "raps admin user update-in-project -p $env:PROJECT_ID -u $env:USER_ID -r $env:NEW_ROLE_ID" `
...
Invoke-Sample -Id "SR-201" -Slug "admin-user-remove-single" `
  -Command "raps admin user remove-from-project -p $env:PROJECT_ID -u $env:USER_ID -y" `
...
Invoke-Sample -Id "SR-202" -Slug "admin-user-import-csv" `
  -Command "raps admin user import -p $env:PROJECT_ID --from-csv ./new-users.csv" `
...
Invoke-LifecycleStep -StepNum 1 -Command "raps admin user list -a $env:ACCT --search `"departing@company.com`""
Invoke-LifecycleStep -StepNum 2 -Command "raps admin user remove departing@company.com -a $env:ACCT --dry-run"
Invoke-LifecycleStep -StepNum 3 -Command "raps admin user remove departing@company.com -a $env:ACCT -y"
Invoke-LifecycleStep -StepNum 4 -Command "raps admin user list -a $env:ACCT --search `"departing@company.com`""
End-Lifecycle
...
Invoke-LifecycleStep -StepNum 1 -Command "raps admin user import -p $env:PROJECT_ID --from-csv ./bulk-users.csv"
Invoke-LifecycleStep -StepNum 2 -Command "raps admin user list -a $env:ACCT -p $env:PROJECT_ID"
Invoke-LifecycleStep -StepNum 3 -Command "raps admin user update user1@co.com -a $env:ACCT --from-csv ./role-updates.csv -y"
Invoke-LifecycleStep -StepNum 4 -Command "raps admin user list -a $env:ACCT -p $env:PROJECT_ID --role `"project_admin`""
End-Lifecycle
