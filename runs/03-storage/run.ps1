...
Invoke-Sample -Id "SR-050" -Slug "bucket-create" `
  -Command "raps bucket create --name `"test-bucket-$([DateTimeOffset]::UtcNow.ToUnixTimeSeconds())`" --policy transient" `
...
Invoke-Sample -Id "SR-052" -Slug "bucket-info" `
  -Command "raps bucket info --name $env:BUCKET_NAME" `
...
Invoke-Sample -Id "SR-053" -Slug "bucket-delete" `
  -Command "raps bucket delete --name $env:BUCKET_NAME --yes" `
...
Invoke-Sample -Id "SR-054" -Slug "object-upload" `
  -Command "raps object upload --bucket $env:BUCKET --file ./test-data/sample.ifc" `
...
Invoke-Sample -Id "SR-055" -Slug "object-upload-batch" `
  -Command "raps object upload-batch --bucket $env:BUCKET --dir ./test-data/" `
...
Invoke-Sample -Id "SR-056" -Slug "object-list" `
  -Command "raps object list --bucket $env:BUCKET" `
...
Invoke-Sample -Id "SR-057" -Slug "object-info" `
  -Command "raps object info --bucket $env:BUCKET --key sample.ifc" `
...
Invoke-Sample -Id "SR-058" -Slug "object-download" `
  -Command "raps object download --bucket $env:BUCKET --key sample.ifc --output ./downloads/" `
...
Invoke-Sample -Id "SR-059" -Slug "object-signed-url" `
  -Command "raps object signed-url --bucket $env:BUCKET --key sample.ifc" `
...
Invoke-Sample -Id "SR-060" -Slug "object-copy" `
  -Command "raps object copy --bucket $env:BUCKET --key sample.ifc --dest-bucket $env:DEST_BUCKET --dest-key sample-copy.ifc" `
...
Invoke-Sample -Id "SR-061" -Slug "object-rename" `
  -Command "raps object rename --bucket $env:BUCKET --key sample-copy.ifc --new-key renamed.ifc" `
...
Invoke-Sample -Id "SR-062" -Slug "object-delete" `
  -Command "raps object delete --bucket $env:BUCKET --key renamed.ifc --yes" `
...
Invoke-LifecycleStep -StepNum 1 -Command "raps bucket create --name lifecycle-test --policy transient"
Invoke-LifecycleStep -StepNum 2 -Command "raps bucket list"
Invoke-LifecycleStep -StepNum 3 -Command "raps bucket info --name lifecycle-test"
Invoke-LifecycleStep -StepNum 4 -Command "raps bucket delete --name lifecycle-test --yes"
...
Invoke-LifecycleStep -StepNum 1  -Command "raps bucket create --name obj-lifecycle --policy transient"
Invoke-LifecycleStep -StepNum 2  -Command "raps object upload --bucket obj-lifecycle --file ./test-data/sample.ifc"
Invoke-LifecycleStep -StepNum 3  -Command "raps object list --bucket obj-lifecycle"
Invoke-LifecycleStep -StepNum 4  -Command "raps object info --bucket obj-lifecycle --key sample.ifc"
Invoke-LifecycleStep -StepNum 5  -Command "raps object signed-url --bucket obj-lifecycle --key sample.ifc"
Invoke-LifecycleStep -StepNum 6  -Command "raps object download --bucket obj-lifecycle --key sample.ifc --output ./tmp/"
Invoke-LifecycleStep -StepNum 7  -Command "raps object rename --bucket obj-lifecycle --key sample.ifc --new-key moved.ifc"
Invoke-LifecycleStep -StepNum 8  -Command "raps object list --bucket obj-lifecycle"
Invoke-LifecycleStep -StepNum 9  -Command "raps object delete --bucket obj-lifecycle --key moved.ifc --yes"
Invoke-LifecycleStep -StepNum 10 -Command "raps bucket delete --name obj-lifecycle --yes"
End-Lifecycle

# SR-065: Batch upload lifecycle
Start-Lifecycle -Id "SR-065" -Slug "batch-upload-lifecycle" -Description "Batch upload test"
Invoke-LifecycleStep -StepNum 1 -Command "raps generate files --count 3 --output ./batch-test/ --complexity simple"
Invoke-LifecycleStep -StepNum 2 -Command "raps bucket create --name batch-test --policy transient"
Invoke-LifecycleStep -StepNum 3 -Command "raps object upload-batch --bucket batch-test --dir ./batch-test/"
Invoke-LifecycleStep -StepNum 4 -Command "raps object list --bucket batch-test"
Invoke-LifecycleStep -StepNum 5 -Command "raps bucket delete --name batch-test --yes"
End-Lifecycle
