...
Invoke-Sample -Id "SR-240" -Slug "report-rfi-summary" `
  -Command "raps report rfi-summary --account $env:ACCOUNT_ID --filter `"Tower`" --status open --since `"2026-01-01`"" `
...
Invoke-Sample -Id "SR-241" -Slug "report-issues-summary" `
  -Command "raps report issues-summary --account $env:ACCOUNT_ID --filter `"Phase 2`" --status open" `
...
Invoke-Sample -Id "SR-242" -Slug "report-submittals-summary" `
  -Command "raps report submittals-summary --account $env:ACCOUNT_ID" `
...
Invoke-Sample -Id "SR-243" -Slug "report-checklists-summary" `
  -Command "raps report checklists-summary --account $env:ACCOUNT_ID --status `"in_progress`"" `
...
Invoke-Sample -Id "SR-244" -Slug "report-assets-summary" `
  -Command "raps report assets-summary --account $env:ACCOUNT_ID --filter `"Hospital`"" `
