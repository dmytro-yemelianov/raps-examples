...
run_sample "SR-137" "issue-comment-delete" \
  "raps issue comment delete \$PROJECT_ID \$ISSUE_ID \$COMMENT_ID --yes" \
...
run_sample "SR-139" "issue-delete" \
  "raps issue delete \$PROJECT_ID \$ISSUE_ID --yes" \
