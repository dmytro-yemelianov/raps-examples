...
Invoke-Sample -Id "SR-220" -Slug "admin-folder-rights-dryrun" `
  -Command "raps admin folder rights user@company.com --account $env:ACCT --level view-download-upload --folder `"Plans`" --filter `"Tower`" --dry-run" `
...
Invoke-Sample -Id "SR-221" -Slug "admin-folder-rights-execute" `
  -Command "raps admin folder rights user@company.com --account $env:ACCT --level view-download-upload --folder `"Plans`" --filter `"Tower`" --yes" `
...
Invoke-Sample -Id "SR-222" -Slug "admin-folder-rights-from-file" `
  -Command "raps admin folder rights user@company.com --account $env:ACCT --level folder-control --project-ids ./projects.txt --yes" `
...
Invoke-Sample -Id "SR-223" -Slug "admin-company-list" `
  -Command "raps admin company-list --account $env:ACCOUNT_ID" `
...
Invoke-Sample -Id "SR-227" -Slug "admin-operation-cancel" `
  -Command "raps admin operation cancel $env:OPERATION_ID --yes" `
...
Invoke-LifecycleStep -StepNum 1 -Command "raps admin folder rights user@co.com --account $env:ACCT --level view-download-upload-edit --folder `"Plans`" --filter `"Active`" --dry-run"
Invoke-LifecycleStep -StepNum 2 -Command "raps admin folder rights user@co.com --account $env:ACCT --level view-download-upload-edit --folder `"Plans`" --filter `"Active`" --yes"
...
Invoke-LifecycleStep -StepNum 5 -Command "raps admin folder rights user@co.com --account $env:ACCT --level view-only --folder `"Plans`" --filter `"Active`" --yes"
